    ...
    <Routes>
      ...
      >
        ...
        <Route
          ...
          element={
            <AdminContentHistory entityType="profile" backTo="/profile" />
          }
        />
        ...
        <Route
          ...
          element={
            <AdminContentHistory entityType="project" backTo="/projects" />
          }
        />
        ...
        <Route
          ...
          element={<AdminContentHistory entityType="skill" backTo="/skills" />}
        />
        ...
        <Route
          path="/experience/:id/history"
          element={
            <AdminContentHistory entityType="experience" backTo="/experience" />
          }
        />
        ...
        <Route
          path="/education/:id/history"
          element={
            <AdminContentHistory entityType="education" backTo="/education" />
          }
        />
